...
export default function SuperadminDashboard() {
  ...
  return (
    <div className="text-slate-900 text-sm leading-5 min-h-screen flex overflow-hidden bg-slate-100 font-sans">
      
      {/* SideNavBar (Clean Light Style) */}
      <nav className="hidden md:flex flex-col h-full p-2 w-65 bg-white text-slate-700 fixed left-0 top-0 border-r border-slate-200 z-20 shadow-sm">
        <div className="px-4 py-6 mb-2 flex items-center gap-3">
          <img 
            className="w-8 h-8 object-contain rounded" 
            src="assets/images/logo-kawung.png" 
            alt="Kawung Finance Logo"
          />
          <div>
            <h1 className="text-base font-bold text-slate-900">Kawung Finance</h1>
            <p className="text-[11px] text-slate-500">Internal Finance Portal</p>
          </div>
        </div>

        <div className="flex-1 overflow-y-auto space-y-1 px-2 py-2">
          <a className="flex items-center gap-3 px-3.5 py-2.5 bg-red-50 text-primary rounded-lg font-semibold" href="#">
            <span className="material-symbols-outlined text-[20px]">dashboard</span>
            Dashboard
          </a>
          <a className="flex items-center gap-3 px-3.5 py-2.5 text-slate-600 hover:bg-slate-100 transition-colors rounded-lg font-medium" href="#">
        ...
        <div className="p-3 border-t border-slate-200 mt-auto">
          <a className="flex items-center gap-3 px-3 py-2 text-slate-600 hover:bg-slate-100 transition-colors rounded-lg mb-1 font-medium" href="#">
            <span className="material-symbols-outlined text-[20px]">help</span>
            Help Center
          </a>
          <button className="w-full flex items-center justify-center gap-2 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors font-medium">
      ...
      {/* Main Workspace */}
      <div className="flex-1 md:ml-65 flex flex-col h-screen overflow-hidden bg-slate-50">
        
        {/* TopNavBar */}
        <header className="hidden md:flex items-center justify-between px-6 w-full h-16 bg-white border-b border-slate-200 z-10 shrink-0 shadow-sm">
          <div className="flex-1 max-w-md">
            <div className="relative flex items-center">
              <span className="material-symbols-outlined absolute left-3 text-slate-400 text-[20px]">search</span>
              <input 
                className="w-full pl-10 pr-4 py-2 bg-slate-100 border border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-primary/30 focus:border-primary text-xs outline-none transition-all" 
          ...
          <div className="flex items-center gap-6">
            <nav className="hidden lg:flex gap-6 font-bold text-xs uppercase tracking-wider">
              <a className="text-primary border-b-2 border-primary pb-1" href="#">Dashboard</a>
              <a className="text-slate-500 hover:text-slate-900 transition-all" href="#">Transactions</a>
              <a className="text-slate-500 hover:text-slate-900 transition-all" href="#">Fund Requests</a>
            </nav>
            <div className="flex items-center gap-4">
              <button className="text-slate-500 hover:text-slate-900 transition-colors relative flex items-center">
              ...
              <button className="flex items-center">
                <img 
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCFyykNzjKy-A-NBIkuVwnaLNPAXOeB7lsAKYc1XjfShMEUZliyASIerTkRzTGyKr6pTQBOHr17NxkhQZihyC-YEnAZSldwO47SL3eErMngwdaq0GPX31RF5kBMYCTActPHZS9iO9gum9-x4Al5pnSmgBxiRbWAOB3dI83rSBbIPlAh0e8Odw9ddDcW_w5vCllKJbXDHOLIhKe9Fe01cqlrNIiF0UDSGmSBP6SQS8aa2QzAYJTN8n6e" 
                />
              </button>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-slate-200 shadow-sm rounded-xl p-6 lg:col-span-2 flex flex-col">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <select className="bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-600 py-1.5 pl-3 pr-8 focus:ring-1 focus:ring-primary outline-none">
                    <option>6 Bulan Terakhir</option>
                    <option>Tahun Ini</option>
                  </select>
                </div>
                
                <div className="flex-1 relative min-h-62.5 bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] bg-size[20px_20px] rounded-lg p-4 flex items-end">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-slate-200 shadow-sm rounded-xl flex flex-col lg:col-span-2 overflow-hidden">
                <div className="p-6 border-b border-slate-200 flex justify-between items-center bg-white">
                  ...
                  <button className="text-primary hover:underline text-xs transition-colors flex items-center gap-1 font-semibold">
                ...
                <div className="bg-white border border-slate-200 shadow-sm rounded-xl p-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start justify-between p-3 bg-slate-50 rounded-lg border border-slate-200 hover:border-amber-300 transition-colors">
                      ...
                      <button className="w-8 h-8 rounded bg-primary text-white flex items-center justify-center hover:bg-red-700 transition-colors shrink-0 shadow-sm">
                  ...
                  <button className="w-full mt-4 text-center text-xs text-primary hover:underline font-semibold">Lihat 3 lainnya</button>
                </div>
